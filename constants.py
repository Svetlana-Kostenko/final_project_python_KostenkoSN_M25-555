...
HELP_TEXT = """   
    Доступные команды:
      ...
      get-rate  --from <валюта> --to <валюта> — получить текущий курс одной валюты к другой (автоматическое обновление если данные обновлялись более 5 минут назад)
      update — обновить курсы валют
